...
Gui, 1: Add, Button, gOffCGI x88 y136 w43 h23, OFF
if GlLanguage
...
Gui, 1: Add, CheckBox, vCheckboxtooltipVvoba x16 y228 w126 h16 Checked%showtooltipVvoba%, Tooltip MacroKey
if GlLanguage
Gui, 1: Add, CheckBox, vCheckboxshowmegui x16 y249 w126 h16 Checked%showmegui%, GUI при запуске
Else
Gui, 1: Add, CheckBox, vCheckboxshowmegui x16 y249 w126 h16 Checked%showmegui%, GUI at startup


Gui, 1: Add, CheckBox, vCheckboxGlLanguage x160 y104 w120 h23 Checked%GlLanguage%, RU language GUI



;===============================Лира ветров
Gui, 1: Add, GroupBox, x8 y168 w139 h56, Windsong Lyre
Gui, 1: Add, Button, gParsButton x16 y192 w31 h21, Pars
Gui, 1: Add, Button, gClearButton x64 y192 w31 h21, Clear
Gui, 1: Add, Button, gRunButton x112 y192 w31 h21, Run
...
Gui, 1: Tab, 5 	;===============Решейд
if GlLanguage
Gui, 1: Add, GroupBox, x8 y24 w180 h96, Решейд
Else
Gui, 1: Add, GroupBox, x8 y24 w180 h96, ReShade
...
Gui, 1: Add, Button, g1ReshadeInstal x16 y128 w39 h23, Instal
Gui, 1: Add, Button, g1ReshadeRemove x72 y128 w55 h23, Remove
Gui, 1: Add, Button, g1ReshadeRun x144 y128 w39 h23, Run
Gui, 1: Add, Text, x16 y160 w120 h23 +0x200, Step 1. Remove
Gui, 1: Add, Text, x16 y184 w120 h23 +0x200, Step 2. Pick
Gui, 1: Add, Text, x16 y208 w120 h23 +0x200, Step 3. Instal
Gui, 1: Add, Text, x16 y232 w157 h23 +0x200, Step 4. Run and start the game
Gui, 1: Tab, 6 	;===============Хекс
...
Gui, 1: Add, Button, gcancelexit x344 y288 w43 h23, Cancel
Gui, 1: Add, Button, gsavegui x288 y288 w43 h23, Save
...
Gui, 1: Submit, NoHide
Gui, 1: Cancel
FileDelete, %EditDir%\Genshin Impact Game\reshade-shaders\dxgi.dll.temp
Loop 30
{
sleep 500
...
if (ListResPickVarNext == 1)
FileCopy, data\reshade\1\ReShade.ini, %EditDir%\Genshin Impact Game, 1
if (ListResPickVarNext == 2)
FileCopy, data\reshade\2\ReShade.ini, %EditDir%\Genshin Impact Game, 1
if (ListResPickVarNext == 3)
FileCopy, data\reshade\3\ReShade.ini, %EditDir%\Genshin Impact Game, 1
if (ListResPickVarNext == 4)
FileCopy, data\reshade\4\ReShade.ini, %EditDir%\Genshin Impact Game, 1
if (ListResPickVarNext == 5)
FileCopy, data\reshade\5\ReShade.ini, %EditDir%\Genshin Impact Game, 1
Else
FileCopy, data\reshade\5\ReShade.ini, %EditDir%\Genshin Impact Game, 1
return
